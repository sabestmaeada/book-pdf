...
> **ไม่ใช้ `--optimize-images -j 90`** — flag นี้ re-encode JPEG ลดคุณภาพ ทำให้รูปเบลอ
> ถ้าอยาก PDF เล็ก เพิ่มกลับมา (จะเสียคุณภาพ)
...
weasyprint -s css/sizes/size_170x228.css -s css/styles/style_bw.css \
  ...
  -s css/no-marks.css \
  --pdf-variant pdf/x-4 -D 300 -c .weasy-cache \
...
| `style_cmyk_template01.css`  | CMYK (สี่สี) — template01 _(ติดกัน)_ |
